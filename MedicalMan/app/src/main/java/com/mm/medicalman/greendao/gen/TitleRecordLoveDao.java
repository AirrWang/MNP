...
/** 
 * DAO for table "TITLE_RECORD_LOVE".
*/
public class TitleRecordLoveDao extends AbstractDao<TitleRecordLove, String> {

    public static final String TABLENAME = "TITLE_RECORD_LOVE";

    /**
     * Properties of entity TitleRecordLove.<br/>
    ...
    public TitleRecordLoveDao(DaoConfig config) {
        super(config);
    }
    
    public TitleRecordLoveDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TITLE_RECORD_LOVE\" (" + //
                "\"C_ID\" TEXT," + // 0: c_id
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TITLE_RECORD_LOVE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TitleRecordLove entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TitleRecordLove entity) {
        stmt.clearBindings();
    ...
    @Override
    public TitleRecordLove readEntity(Cursor cursor, int offset) {
        TitleRecordLove entity = new TitleRecordLove( //
    ...
    @Override
    public void readEntity(Cursor cursor, TitleRecordLove entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(TitleRecordLove entity, long rowId) {
        return entity.getQ_id();
    }
    
    @Override
    public String getKey(TitleRecordLove entity) {
        if(entity != null) {
            return entity.getQ_id();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(TitleRecordLove entity) {
