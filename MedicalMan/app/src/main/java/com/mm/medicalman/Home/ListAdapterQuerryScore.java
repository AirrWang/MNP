 ...
 */
public class ListAdapterQuerryScore extends BaseAdapter {

    public List<GetscoresBean.LoginInfoBean.ScoresBean> getDataSource() {
        return dataSource;
    }

    public void setDataSource(List<GetscoresBean.LoginInfoBean.ScoresBean> dataSource) {
        this.dataSource = dataSource;
    }

    private List<GetscoresBean.LoginInfoBean.ScoresBean> dataSource;
    private Context context;


    public ListAdapterQuerryScore(Context context) {
