...
/** 
 * DAO for table "TITLE_RECORD_EXAMINATION".
*/
public class TitleRecordExaminationDao extends AbstractDao<TitleRecordExamination, String> {

    public static final String TABLENAME = "TITLE_RECORD_EXAMINATION";

    /**
     * Properties of entity TitleRecordExamination.<br/>
    ...
    public TitleRecordExaminationDao(DaoConfig config) {
        super(config);
    }
    
    public TitleRecordExaminationDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TITLE_RECORD_EXAMINATION\" (" + //
                "\"C_ID\" TEXT," + // 0: c_id
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TITLE_RECORD_EXAMINATION\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TitleRecordExamination entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TitleRecordExamination entity) {
        stmt.clearBindings();
    ...
    @Override
    public TitleRecordExamination readEntity(Cursor cursor, int offset) {
        TitleRecordExamination entity = new TitleRecordExamination( //
    ...
    @Override
    public void readEntity(Cursor cursor, TitleRecordExamination entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(TitleRecordExamination entity, long rowId) {
        return entity.getQ_id();
    }
    
    @Override
    public String getKey(TitleRecordExamination entity) {
        if(entity != null) {
            return entity.getQ_id();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(TitleRecordExamination entity) {
