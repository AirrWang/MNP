 ...
 */
@Entity
public class TitleRecordExamination {
    ...
    @Generated(hash = 964464374)
    public TitleRecordExamination(String c_id, String q_id, String s1, String s2,
            String s3, String s4, String s5, String is_right) {
        this.c_id = c_id;
        this.q_id = q_id;
        this.s1 = s1;
        this.s2 = s2;
    ...
    @Generated(hash = 1060342890)
    public TitleRecordExamination() {
    }
