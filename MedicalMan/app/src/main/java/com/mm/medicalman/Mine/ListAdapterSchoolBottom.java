 ...
 */
public class ListAdapterSchoolBottom extends BaseAdapter {

    private List<MySchoolBean.MySchoolDetailBean.NoticelistBean> list;
    private Context context;

    public ListAdapterSchoolBottom(Context context) {
        super();
    ...
    public void setList(List<MySchoolBean.MySchoolDetailBean.NoticelistBean> list) {
        this.list = list;
    }
