 ...
 */
@Entity
public class TitleRecordPracticeCompetence {
    ...
    @Generated(hash = 1100257540)
    public TitleRecordPracticeCompetence(String c_id, String q_id, String s1,
    ...
    @Generated(hash = 1591839002)
    public TitleRecordPracticeCompetence() {
    }
