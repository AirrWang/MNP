...
public class TitleRecordLove {
    ...
    @Generated(hash = 1712132910)
    public TitleRecordLove(String c_id, String q_id, String s1, String s2,
    ...
    @Generated(hash = 1165541840)
    public TitleRecordLove() {
    }
