...
public class MockRule {
    ...
    @Generated(hash = 1616580995)
    public MockRule(String id, String minute, String q_num, String rule_score,
            String rule_question, String q_difficulty_type, String q_difficulty_num,
            String q_class_c_id, String q_class_num) {
        this.id = id;
        this.minute = minute;
        this.q_num = q_num;
